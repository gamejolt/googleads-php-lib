...
class AdWordsUser extends AdsUser {
  ...
  protected function InitLogs() {
    parent::InitLogs();
    \GoogleApi\Logger::LogToFile(self::REPORT_LOG_CHANNEL_NAME,
        $this->GetLogsDirectory() . DIRECTORY_SEPARATOR
            . self::REPORT_LOG_FILE_NAME);
    \GoogleApi\Logger::SetLogLevel(self::REPORT_LOG_CHANNEL_NAME, \GoogleApi\Logger::$FATAL);
  }
  ...
  public function LogDefaults() {
    parent::LogDefaults();
    \GoogleApi\Logger::SetLogLevel(self::REPORT_LOG_CHANNEL_NAME, \GoogleApi\Logger::$ERROR);
  }
  ...
  public function LogAll() {
    parent::LogAll();
    \GoogleApi\Logger::SetLogLevel(self::REPORT_LOG_CHANNEL_NAME, \GoogleApi\Logger::$INFO);
  }
